  ...
  <div class="dialog-content" role="document">
    <div class="container relative">
      ...
      <div class="card card--lg border-y-2 border-[#74808A] text-[#74808A] p-8 mb-16">
        <h2 class="text-white font-bold text-2xl mt-0">From RTP Leadership</h2>
        <div class="text-white clearfix">
          ...
          <div class="text-white">
            ...
            <p>Our community propels our ambition and allows us to make RTP an engaging, accessible, welcoming place for all. With powerful collaborations and relationships as the backbone for everything we do, we’re working to build a more diverse, inclusive and equitable RTP supporting our 400 companies.</p>
