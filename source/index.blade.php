            ...
            <div class="grid gap-4 md:grid-cols-12">
              ...
              <div class="col-span-4">
                ...
                <ul class="list-disc pl-4 font-bold">
                  <li class="mb-4">TCREW Champion Award: Best Development Project 2022</li>
                  <li class="mb-4">Triangle Business Journal’s 2022 Space Awards for Top Retail Development (Paywall)</li>
                  <li class="mb-4">Durham Magazine Best Venue for Live Music 2022</li>
                  <li class="mb-4">Best of Durham Large Venue for Live Music</li>
                  <li class="mb-4">
                    Best of Durham (Vendors)
                    <ul class="list-disc pl-4 font-normal">
                      <li>Lawrence Barbecue: Best Of Durham Barbecue</li>
                      <li>Beyu Caffe: Best Of Durham Coffee Shop</li>
                      <li>Fullsteam Brewery: Best Of Durham Brewery</li>
                      <li>Wonderpuff: Best Of Durham Artisan Food Product</li>
                    </ul>
                  </li>
                </ul>
              </div>
          ...
          <div tabindex="0" role="tabpanel" id="tabpanel-hub" aria-labelledby="tab-hub" hidden>
            ...
            <div class="grid gap-4 md:grid-cols-12">
              <div class="col-span-6">
                ...
                <p class="font-bold">This year, we opened an immersive Experience Center equipped with a 3D model and VR walkthrough of the development, a display wall with branded items exhibiting Hub’s energy, a breezeway overlooking the construction site, and AV displays featuring travel times and stock tickers of RTP companies.</p>
              </div>
              <div class="col-span-6">
                <h3 class="text-xl font-bold text-light-blue">Awards & Accolades</h3>
                <ul class="list-none font-bold">
                  <li class="mb-4">Huburban Carpool Convos: Take a tour of the Triangle with us and some of the Triangle’s most notable leaders. Here, we discuss what Hub RTP means for our growing region.</lie>
                  <li class="mb-4">Durham Bull’s: XX</li>
                </ul>
              </div>
            </div>
            <div class="grid gap-4 md:grid-cols-12">
              <div class="col-span-8">
                ...
                <ul class="list-none md:columns-2 gap-3 font-bold">
                  <li class="mb-4">We will double in population, so what must the Triangle do? Research Triangle Foundation CEO says…</li>
                  <li class="mb-4">The future of RTP: Horseshoe at Hub RTP celebrates groundbreaking on Tuesday</li>
                  <li class="mb-4">First ‘Hub RTP’ project starts construction; more projects to come A ‘new downtown for RTP’ and ‘a brand new RTP:’ Horseshoe at the Hub project is underway</li>
                  <li class="mb-4">Tired of commuting to RTP? Pretty soon you’ll be able to live there. (Paywall)</li>
                  <li class="mb-4">Research Triangle Park will soon have something for the first time ever: residents</li>
                  <li class="mb-4">Hub RTP update: Park’s first apartments coming soon to planned urban campus</li>
                  <li class="mb-4">TBD/CONFIDENTIAL: Data443 announced as the first tenant for Horseshoe at Hub RTP</li>
                </ul>
              </div>
              <div class="col-span-4">
          ...
          @foreach ($recipients as $recipient)
            <article class="relative sm:col-span-6 lg:col-span-4">
              <figure class="flex items-center justify-center relative min-h-[300px] bg-black bg-opacity-5">
                <img class="lazyload absolute w-full h-full object-contain object-center max-w-[400px] p-8" data-src="{{ $recipient->logo }}" alt="" data-expand="-10" />
              </figure>
              <h4 class="mt-4">
                @if ($recipient->link)
          ...
          <div class="grid gap-4 md:grid-cols-12">
            <div class="col-span-8">
              <div class="flex flex-col justify-between h-full">
                ...
                <a class="inline-block bg-slate text-white p-4 self-start hover:bg-slate-900 focus:bg-slate-900 transition-colors duration-300" href="#">Listen to the Crossroads Podcast</a>
              </div>
            </div>
